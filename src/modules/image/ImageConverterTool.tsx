          ...
          {!file ? (
            <div className="border-2 border-dashed border-slate-300 dark:border-slate-700 rounded-xl p-12 text-center hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors relative">
              ...
              <div className="flex flex-col items-center pointer-events-none">
                ...
                <p className="text-sm text-slate-500 mt-2">Suporta JPG, PNG, WEBP e mais</p>
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-center text-slate-500">
                  Tamanho: <span className="font-mono font-medium text-slate-700 dark:text-slate-300">{formatBytes(file.size)}</span>
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg p-5 space-y-5">
                  ...
                  {options.format !== 'image/png' && (
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Qualidade de Compressão</label>
                      ...
                      />
                      <p className="text-xs text-slate-500 mt-1">Valores menores reduzem o tamanho, mas perdem nitidez.</p>
                    </div>
                  )}
                  ...
                  <Button 
                    ...
                    icon={Zap}
                  >
                    {isProcessing ? 'A processar...' : 'Otimizar Imagem'}
                  </Button>
                </div>
                ...
                {resultBlob && (
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-5 text-center space-y-4 animate-in slide-in-from-bottom-4">
                    <div>
                      <p className="text-sm text-green-800 dark:text-green-300 font-medium">Novo Tamanho</p>
