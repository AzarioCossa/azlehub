    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="relative max-w-xl mx-auto group mb-12">
        ...
        <input
          ...
          placeholder="Pesquisar ferramentas (ex: JWT, PDF, Hash)..."
      ...
      {filteredTools.length > 0 ? (
        ...
        <div className="text-center py-16 animate-in zoom-in-95 duration-300">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">
            Não encontrámos resultados para "<span className="font-medium text-slate-700 dark:text-slate-300">{searchQuery}</span>".
          </p>
          <button 
            onClick={() => setSearchQuery('')}
